  ...
  "node_modules/undici/lib/web/fetch/response.js"(exports, module) {
    ...
    function initializeResponse(response2, init, body) {
      ...
      if (body) {
        ...
        if (body.type != null && !response2[kState].headersList.contains("content-type", true)) {
          response2[kState].headersList.append("content-type", body.type, true);
        }
      }
    }
      ...
      async match(request2, options = {}) {
        ...
        if (options.cacheName != null) {
          ...
          for (const cacheList of this.#caches.values()) {
            const cache = new Cache(kConstruct, cacheList);
            const response2 = await cache.match(request2, options);
            if (response2 !== void 0) {
              return response2;
            }
          }
      ...
      request(verb, requestUrl, data, headers) {
        return __awaiter7(this, void 0, void 0, function* () {
          ...
          do {
            ...
            if (response2 && response2.message && response2.message.statusCode === HttpCodes2.Unauthorized) {
            ...
            while (response2.message.statusCode && HttpRedirectCodes2.includes(response2.message.statusCode) && this._allowRedirects && redirectsRemaining > 0) {
            ...
            if (!response2.message.statusCode || !HttpResponseRetryCodes2.includes(response2.message.statusCode)) {
              return response2;
            }
            numTries += 1;
...
// .github/actions/deploy/index.ts
import { inspect } from "util";
var githubToken = getInput("token");
var artifactId = parseInt(getInput("artifact-id"));
var buildVersion = process.env.GITHUB_SHA;
var idToken = await getIDToken();
var octokit = getOctokit(githubToken);
var response = await octokit.request("POST /repos/{owner}/{repo}/pages/deployments", {
